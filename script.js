const I18N = {
  en: {
    ...
    "hero.subtitle":
      "ASTechno is the trading name of AS Technology V.O.F. in the Netherlands. We build reliable software products with care and long-term intent.",
    "hero.ctaPrimary": "Email us",
    "hero.ctaSecondary": "What we're building",
    "building.title": "What we're building",
    "building.body1":
      "ASTechno is developing its first product internally. We're currently focused on designing, validating, and building an MVP.",
  ...
  nl: {
    ...
    "hero.subtitle":
      "ASTechno is de handelsnaam van AS Technology V.O.F. in Nederland. We bouwen betrouwbare softwareproducten met aandacht en met een langetermijnvisie.",
    "hero.ctaPrimary": "Mail ons",
    "hero.ctaSecondary": "Wat we bouwen",
    "building.title": "Wat we bouwen",
    "building.body1":
      "ASTechno ontwikkelt intern zijn eerste product. We richten ons momenteel op het ontwerpen, valideren en bouwen van een MVP.",
  ...
  ar: {
    ...
    "hero.subtitle":
      "ASTechno هو الاسم التجاري لشركة AS Technology V.O.F. في هولندا. نبني منتجات برمجية موثوقة بعناية وبرؤية طويلة المدى.",
    "hero.ctaPrimary": "راسلنا",
    "hero.ctaSecondary": "ماذا نبني",
    "building.title": "ماذا نبني",
    "building.body1":
      "تعمل ASTechno على تطوير أول منتج لها داخليًا. نركز حاليًا على التصميم والتحقق وبناء نسخة MVP.",
